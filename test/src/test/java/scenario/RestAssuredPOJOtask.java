...
public class RestAssuredPOJOtask {
    /*
    ...
    */
    ...
    public void addObject(){
        ...
        */
        ...
        // Validate Response
        Assert.assertEquals(responseProducts.name, "Apple MacBook Zahwa");
        Assert.assertEquals(responseProducts.data.year, "2025");
        Assert.assertEquals(responseProducts.data.price, 20000000);
        Assert.assertEquals(responseProducts.data.cpuModel, "Intel Core i7");
        ...
        Assert.assertEquals(responseProducts.data.color, "starlight");
    }
    ...
    */
        ...
        // Validate Response
        Assert.assertEquals(responseProducts.name, "Apple MacBook Zahwa Putri Hamida");
        Assert.assertEquals(responseProducts.data.year, "2028");
        Assert.assertEquals(responseProducts.data.price, 22000000);
        Assert.assertEquals(responseProducts.data.cpuModel, "Intel Core i9");
        Assert.assertEquals(responseProducts.data.hardDiskSize, "2 TB");
        Assert.assertEquals(responseProducts.data.capacity, "5");
        Assert.assertEquals(responseProducts.data.screenSize, "15");
        Assert.assertEquals(responseProducts.data.color, "coral");
    }
